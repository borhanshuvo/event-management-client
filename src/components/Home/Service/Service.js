...
const Service = () => {
    ...
    return (
        <div className="container pt-5 pb-5">
            ...
            <h4 className="text-center pb-3" style={textColor}><u>It's Simple</u></h4>
            ...
            <h5 className="text-center pb-5" style={textColor}>HERE IS HOW WE CAN HELP YOU</h5>
                {
                    services.map(service => 
                        <div key={service._id} className="col-md-4 pb-3">
                            <div className="card">
                                <img src={`data:image/png;base64,${service.image.img}`} style={{ height: '200px' }} className="img-fluid" alt="" />
