...
const HeaderMain = () => {
    const btnDesign = { fontSize: '20px', backgroundImage: 'linear-gradient(90deg, #19D3AF, #0FCFEA)', border: 'none', padding: '15px 30px', color: 'white', borderRadius: '10px', textDecoration: 'none' };
                ...
                <div className="row">
                    <div className="col-md-6 pb-5">
                        <div className="pt-5">
                            ...
                            <a style={btnDesign} href="#service">Book Now</a>
                        </div>
                    </div>
